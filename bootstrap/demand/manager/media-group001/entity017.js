...
// fixture(s)
const testFixture =
    require(rootPath + '/fixtures/common/campaign/create016');
...
describe('{{BOOTSTRAP}} <SETUP> [[MEDIA-GROUP]] 017 >>> ' +
    'mediaGroup001 - advertiser001 - insertionOrder003 - ' +
    'campaign005 >>> ' +
    'performance - max clicks >>>', function() {
    ...
    before('create campaign - ssp - exchange - ' +
        ...
        sendBody001.name += '005' + timeStampLong;
    ...
    after('write entity to json file', function(done) {
        ...
        const createdEntity = {
            ...
            goalDescription: 'performance - maximize clicks',
