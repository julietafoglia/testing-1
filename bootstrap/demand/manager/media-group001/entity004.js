...
describe('{{BOOTSTRAP}} <SETUP> [[MEDIA-GROUP]] 004 >>> ' +
    'mediaGroup001 - advertiser001 - insertionOrder001 - ' +
    'campaign001 >>> ' +
    'ssp - exchange - newsletter - ' +
    ...
    before('create campaign - ssp - exchange - ' +
        ...
        sendBody001.demandType = 'exchange';
    ...
    it('response object key values ' +
        ...
        expect(resOutput001.demandType).to.equal('exchange');
    ...
    after('write entity to json file', function(done) {
        ...
        const createdEntity = {
            ...
            goalDescription: 'branding - impressions',
        ...
        baseEntityObj.children.campaign001 = {};
        baseEntityObj.children.campaign001 = createdEntity;
