...
// fixture(s)
const testFixture =
    require(rootPath + '/fixtures/common/campaign/create010');
...
describe('{{BOOTSTRAP}} <SETUP> [[MEDIA-GROUP]] 009 >>> ' +
    'mediaGroup001 - advertiser001 - insertionOrder001 - ' +
    'campaign002 >>> ' +
    'ssp - direct sold - newsletter - ' +
    'currency - cpm - 2nd price >>>', function() {
    ...
    before('create campaign - ssp - direct sold - ' +
        ...
        sendBody001.type = 'newsletter';
        sendBody001.demandType = 'direct';
        sendBody001.budgetType = 'currency';
        sendBody001.pricingModel = 'CPM';
        sendBody001.clearingMethod = '1stPrice';
