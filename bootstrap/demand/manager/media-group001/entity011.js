...
describe('{{BOOTSTRAP}} <SETUP> [[MEDIA-GROUP]] 011 >>> ' +
    ...
    before('create insertion order - minimum required', function(done) {
        ...
        sendBody001.name += '003' + ' (house campaigns) ' + timeStampLong;
    ...
    after('write entity to json file', function(done) {
        ...
        baseEntityObj.children.insertionOrder003 = {};
        baseEntityObj.children.insertionOrder003 = createdEntity;
