...
describe('{{BOOTSTRAP}} <SETUP> [[MEDIA-GROUP]] 018 >>> ' +
    ...
    before('create campaign - ssp - exchange - ' +
        ...
        sendBody001.name += '006' + timeStampLong;
    ...
    after('write entity to json file', function(done) {
        ...
        baseEntityObj.children.campaign006 = {};
        baseEntityObj.children.campaign006 = createdEntity;
