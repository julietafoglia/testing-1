...
describe('{{BOOTSTRAP}} <SETUP> [[MEDIA-GROUP]] 002 >>> ' +
    'mediaGroup001 - advertiser001 >>> ' +
    ...
    before('create advertiser - minimum required', function(done) {
        ...
        sendBody001.owner.type = 'Media Group';
        sendBody001.owner.id = targetMediaGroup.id;
    ...
    after('write entity to json file', function(done) {
        ...
        let baseEntityObj = targetMediaGroup;
