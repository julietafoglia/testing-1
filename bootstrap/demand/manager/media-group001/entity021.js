...
// fixture(s)
const testFixture =
    require(rootPath + '/fixtures/common/campaign/create015');
...
describe('{{BOOTSTRAP}} <SETUP> [[MEDIA-GROUP]] 021 >>> ' +
    'mediaGroup001 - advertiser001 - insertionOrder002 - ' +
    'campaign004 >>> ' +
    'direct sold - performance - max reach >>>', function() {
    ...
    it('response object key values ' +
        ...
        expect(resOutput001.demandType).to.equal('direct');
        ...
        expect(resOutput001.clearingMethod).to.equal('2ndPrice');
        done();
    });
    ...
    after('write entity to json file', function(done) {
        ...
        const createdEntity = {
            ...
            goalDescription: 'performance - maximize reach',
        ...
        baseEntityObj.children.campaign004 = {};
        baseEntityObj.children.campaign004 = createdEntity;
