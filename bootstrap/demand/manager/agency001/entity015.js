...
// fixture(s)
const testFixture =
    require(rootPath + '/fixtures/common/campaign/create009');
const verifyFixture =
    require(rootPath + '/fixtures/common/campaign/create009-verify');
...
describe('{{BOOTSTRAP}} <SETUP> [[AGENCY]] 015 >>> ' +
    'agency001 - advertiser001 - insertionOrder001 - campaign005 >>> ' +
    ...
    before('create campaign - ssp - exchange - ' +
        ...
        sendBody001.name += '005' + timeStampLong + ' (campaign goal)';
    ...
    after('write entity to json file', function(done) {
        ...
        baseEntityObj.children.campaign005 = {};
        baseEntityObj.children.campaign005 = createdEntity;
