...
// fixture(s)
const testFixture =
    require(rootPath + '/fixtures/common/campaign/create014');
const verifyFixture =
    require(rootPath + '/fixtures/common/campaign/create014-verify');
...
describe('{{BOOTSTRAP}} <SETUP> [[AGENCY]] 023 >>> ' +
    'agency001 - advertiser001 - insertionOrder002 - campaign004 >>> ' +
    'exchange - 2nd price - cpa >>>', function() {
    ...
    before('create campaign - dsp - exchange - ' +
        ...
        sendBody001.name += '004' + timeStampLong + ' (perf pay per conv)';
