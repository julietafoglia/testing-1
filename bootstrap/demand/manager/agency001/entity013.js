...
// fixture(s)
const testFixture =
    require(rootPath + '/fixtures/common/campaign/create007');
const verifyFixture =
    require(rootPath + '/fixtures/common/campaign/create007-verify');
...
describe('{{BOOTSTRAP}} <SETUP> [[AGENCY]] 013 >>> ' +
    'agency001 - advertiser001 - insertionOrder001 - campaign003 >>> ' +
    ...
    before('create campaign - dsp - exchange - ' +
        ...
        sendBody001.name += '003' + timeStampLong + ' (campaign goal)';
