...
describe('{{BOOTSTRAP}} <SETUP> [[AGENCY]] 001 >>> ' +
    'agency001 (agency) >>> minimum required fields >>>', function() {
    ...
    before('create agency - minimum required', function(done) {
        ...
        sendBody001.salesforceId = chance.string({length: 30});
    ...
    after('write entity to json file', function(done) {
        ...
        if (!entitiesObj.agency001) {
            entitiesObj.agency001 = {};
        }
        entitiesObj.agency001 = createdEntity;
