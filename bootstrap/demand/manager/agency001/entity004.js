...
// fixture(s)
const testFixture =
    require(rootPath + '/fixtures/common/campaign/create011');
const verifyFixture =
    require(rootPath + '/fixtures/common/campaign/create011-verify');
...
describe('{{BOOTSTRAP}} <SETUP> [[AGENCY]] 004 >>> ' +
    'agency001 - advertiser001 - insertionOrder001 - campaign001 >>> ' +
    ...
    before('create campaign - minimum required - agency', function(done) {
