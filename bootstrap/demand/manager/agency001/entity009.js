...
// fixture(s)
const testFixture =
    require(rootPath + '/fixtures/common/campaign/create006');
const verifyFixture =
    require(rootPath + '/fixtures/common/campaign/create006-verify');
...
describe('{{BOOTSTRAP}} <SETUP> [[AGENCY]] 009 >>> ' +
    'agency001 - advertiser001 - insertionOrder001 - campaign002 >>> ' +
    'dsp - exchange - 1st price - cpc >>>', function() {
    ...
    before('create campaign - ssp - exchange - ' +
        '1st price - cpc', function(done) {

        sendBody001 = Object.assign({}, testFixture);

        sendBody001.insertionOrder = targetInsertionOrder.id;
        sendBody001.system = 'ssp';
        sendBody001.name += '002' + timeStampLong + ' (campaign goal)';
    ...
    after('write entity to json file', function(done) {
        ...
        const createdEntity = {
            ...
            goalDescription: 'performance - pay per click',
        ...
        baseEntityObj.children.campaign002 = {};
        baseEntityObj.children.campaign002 = createdEntity;
