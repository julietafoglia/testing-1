...
// fixture(s)
const testFixture =
    require(rootPath + '/fixtures/common/campaign/create008');
const verifyFixture =
    require(rootPath + '/fixtures/common/campaign/create008-verify');
...
describe('{{BOOTSTRAP}} <SETUP> [[AGENCY]] 014 >>> ' +
    'agency001 - advertiser001 - insertionOrder001 - campaign004 >>> ' +
    'ssp - exchange - 1st price - cpa >>>', function() {
