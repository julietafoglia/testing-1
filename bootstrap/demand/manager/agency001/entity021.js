...
// fixture(s)
const testFixture =
    require(rootPath + '/fixtures/common/campaign/create012');
const verifyFixture =
    require(rootPath + '/fixtures/common/campaign/create012-verify');
...
describe('{{BOOTSTRAP}} <SETUP> [[AGENCY]] 021 >>> ' +
    'agency001 - advertiser001 - insertionOrder002 - campaign002 >>> ' +
    'exchange - 1st price - cpm >>>', function() {
    ...
    before('create campaign - dsp - exchange - ' +
        ...
        sendBody001.name += '002' + timeStampLong + ' (branding conversions)';
