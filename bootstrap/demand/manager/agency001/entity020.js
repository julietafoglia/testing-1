...
// fixture(s)
const testFixture =
    require(rootPath + '/fixtures/common/campaign/create019');
const verifyFixture =
    require(rootPath + '/fixtures/common/campaign/create019-verify');
...
describe('{{BOOTSTRAP}} <SETUP> [[AGENCY]] 020 >>> ' +
    'agency001 - advertiser001 - insertionOrder002 - campaign001 >>> ' +
    ...
    before('create campaign - dsp - exchange - ' +
        ...
        sendBody001.name += '001' + timeStampLong + ' (branding clicks)';
