...
// fixture(s)
const testFixture =
    require(rootPath + '/fixtures/common/insertion-order/create005');
const verifyFixture =
    require(rootPath + '/fixtures/common/insertion-order/create005-verify');
...
describe('{{BOOTSTRAP}} <SETUP> [[SS-AGENCY]] 009 >>> ' +
    'agency002 - advertiser001 - insertionOrder002 >>> ' +
    ...
    before('create insertion order - self-service', function(done) {
        sendBody001 = Object.assign({}, testFixture);

        sendBody001.name += '002' + timeStampLong;
        sendBody001.advertiser = targetAdvertiser.id;
        sendBody001.endDate =
            moment().add(25, 'years').format('YYYY-MM-DD HH:mm:ss');
        sendBody001.isSelfService = true;
    ...
    it('response object property types should match spec', function(done) {
        ...
        expect(resOutput001.isSelfService).to.be.a('boolean');
    ...
    it('response object key values should ' +
        ...
        expect(resOutput001.isSelfService)
            .to.equal(sendBody001.isSelfService);
    ...
    after('write entity to json file', function(done) {
        ...
        const createdEntity = {
            ...
            selfService: resOutput001.isSelfService
        };
        ...
        baseEntityObj.children.insertionOrder002 = {};
        baseEntityObj.children.insertionOrder002 = createdEntity;
