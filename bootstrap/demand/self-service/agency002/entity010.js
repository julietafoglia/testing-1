...
// fixture(s)
const testFixture =
    require(rootPath + '/fixtures/common/campaign/create005');
const verifyFixture =
    require(rootPath + '/fixtures/common/campaign/create005-verify');
...
describe('{{BOOTSTRAP}} <SETUP> [[SS-AGENCY]] 010 >>> ' +
    'agency002 - advertiser001 - insertionOrder002 - campaign001 >>> ' +
    'ssp - exchange - cpm - 1st price >>>', function() {
