...
describe('{{BOOTSTRAP}} <SETUP> [[SS-AGENCY]] 006 >>> ' +
    'agency002 - advertiser001 - creative003 >>> ', function(done) {
    ...
    after('write entity to json file', function(done) {
        ...
        baseEntityObj.children.creative003 = {};
        baseEntityObj.children.creative003 = createdEntity;
