...
describe('{{BOOTSTRAP}} <SETUP> [[SS-AGENCY]] 006 >>> ' +
    'agency002 - advertiser001 - creative001 >>> ', function(done) {
    ...
    after('write entity to json file', function(done) {
        ...
        const createdEntity = {
            ...
            trackingUrl: resOutput001.urlTracking1,
            width: resOutput001.width,
            height: resOutput001.height
        };
        ...
        baseEntityObj.children.creative001 = {};
        baseEntityObj.children.creative001 = createdEntity;
