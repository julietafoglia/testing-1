...
describe('{{BOOTSTRAP}} <SETUP> [[SS-AGENCY]] 012 >>> ' +
    'agency002 - advertiser001 - advertiserUser001 >>> ', function(done) {
    ...
    before('create user - minimum required', function(done) {
        ...
        sendBody001.email = 'advSelfService001-'
    ...
    after('write entity to json file', function(done) {
        ...
        baseEntityObj.children.advertiserUser001 = {};
