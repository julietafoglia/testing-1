...
describe('<DEBUG>[BOOTSTRAP-SETUP] /media-group {create} @MANAGER >>> ' +
    ...
    after('save media-group to file', (done) => {
        let entities = {};
        entities.manager = {
            mediaGroup001: {
                id: resOutput001.id,
                ...
                executiveName: resOutput001.executiveName,
                managerName: resOutput001.managerName,
                tagsUrlPrefix: resOutput001.tagsUrlPrefix,
                created: resOutput001.created,
                modified: resOutput001.modified
            }
        };

        jsonfile.writeFile(
            rootPath + '/bootstrap/entities-ssp.json', entities, (err) => {
                if (err) {
                    throw err;
                }
                done();
