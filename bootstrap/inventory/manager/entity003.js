...
// fixture(s)
const testFixture =
    require(rootPath + '/fixtures/common/newsletter/create004');
...
describe('[BOOTSTRAP-SETUP] /newsletter {create} @MANAGER >>> ' +
    '(+) fields that can be entered in the UI - advanced >>>', function() {
    ...
    it('response object key values should match test object', function() {
        ...
        expect(resOutput001.secondaryCategories)
            .to.eql(sendBody001.secondaryCategories);
    ...
    after('save newsletter to file', (done) => {
        publisher.newsletter001 = resOutput001;
        jsonfile.writeFile(
