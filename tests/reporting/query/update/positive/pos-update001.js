...
describe('{{REPORTING}} <SMOKE> /query {update} @ADMIN >>> ' +
    '(+) update query with valid id and body parameters >>>', function() {
    ...
    before('update query', function(done) {
        basicReportBody.meta.granularity = 'month';
