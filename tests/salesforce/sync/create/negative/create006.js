...
describe('{{SALESFORCE}} client direct - agency {create} >>> ' +
    '(-) campaign missing iab category >>>', function() {
    ...
    describe('salesforce - create an agency opportunity >>>', function() {
        ...
        it('should create a new product', function(done) {
            ...
            // set primary IAB category to None
            productFixture.primaryIabCategory = 0;
        ...
        it('should fail to sync to liveintent', function(done) {
            let opportunitiesDetailPage = new OpportunitiesDetailPage(driver);
            opportunitiesDetailPage
                .getChatterFeed(errors.nullIabCategoryError)
                .then((res) => {
