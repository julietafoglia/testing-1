...
describe('{{SALESFORCE}} client direct - agency {update} >>> ' +
    ...
    describe('salesforce - create a agency opportunity >>>', function() {
    ...
    describe('merlin - verify campaign was created', function() {
        ...
        it('response should match product created on sf', function() {
            ...
            expect(resOutput005.insertionOrder)
                .to.equal(resOutput003[0].id);
            ...
            expect(sfHelper.parseFreqCapPeriod(resOutput005.frequencyCapPeriod))
                .to.equal(productFixture.timesPer);
            expect(sfHelper.parseDate(resOutput005.insertionOrderStartDate))
                .to.equal(opportunityFixture.liveDate);
            expect(sfHelper.parseDate(resOutput005.insertionOrderEndDate))
                .to.equal(opportunityFixture.endDate);
    ...
    describe('salesforce - update opportunity and product >>>', function() {
        ...
        opportunityUpdateFixture = Object.assign(
            {}, require(rootPath + '/fixtures/salesforce/opportunity-update002')
        );
        productUpdateFixture = Object.assign(
            {}, require(rootPath + '/fixtures/salesforce/product-update003')
        );
