...
describe('{{SALESFORCE}} client direct - agency {update} >>> ' +
    '(-) product with frequency cap missing times per >>>', function() {
    ...
    describe('salesforce - update product - missing times per >>>', function() {
    ...
    describe('merlin - verify campaign was not updated', function() {
        ...
        it('response should match original product', function() {
            ...
            expect(resOutput011.category)
                .to.equal(productFixture.primaryIabCategory);
            expect(resOutput011.secondaryCategories)
                .to.eql(productFixture.secondaryIabCategories);
