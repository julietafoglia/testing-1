...
describe('{{SALESFORCE}} client direct - direct-advertiser {update} >>> ' +
    '(-) performance maximize conversions - missing pixel >>>', function() {
    ...
    describe('salesforce - update opportunity and product >>>', function() {
        ...
        it('should update existing product - missing pixel', function(done) {
            let productEditPage = new ProductEditPage(driver);
            // update fixture fields
    ...
    describe('merlin - verify campaign was not updated', function() {
        ...
        it('response should match original product', function() {
            ...
            expect(resOutput010.secondaryCategories).to.eql(
                productFixture.secondaryIabCategories
            );
