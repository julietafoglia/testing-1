...
describe('{{SALESFORCE}} agency - agency {update} >>> ' +
    '(-) update opportunity with invalid flight dates >>>', function() {
    ...
    describe('salesforce - create an agency opp >>>', function() {
        ...
        opportunityFixture = Object.assign(
            {}, require(rootPath + '/fixtures/salesforce/opportunity-create004')
        );
        productFixture = Object.assign(
            {}, require(rootPath + '/fixtures/salesforce/product-create007')
        );
        ...
        it('should create a new product - inherits iab cat', function(done) {
            ...
            productEditPage
                ...
                .enterMaxCPMBid(productFixture.maxCpmBid)
                .saveProduct()
                .then((res) => {
                    done();
                }, (err) => {
    ...
    describe('salesforce - update opportunity >>>', function() {
        ...
        it('should edit an existing an opportunity', function(done) {
            let opportunitiesEditPage = new OpportunitiesEditPage(driver);
            // update flight dates to invalid dates
            opportunityUpdateFixture.liveDate =
                moment().subtract(2, 'weeks').format('MM/DD/YYYY');
    ...
    describe('merlin - verify campaign was not updated', function() {
        ...
        it('response should match original product', function() {
            ...
            expect(resOutput011.maxCpm)
                .to.equal(productFixture.maxCpmBid);
