...
describe('{{SALESFORCE}} client direct - agency - product {validation} >>> ' +
    '(+) performance max reach missing max cpm >>>', function() {
    ...
    it('should display error(s) on product save', function(done) {
        ...
        productEditPage
            ...
            .getErrors()
            .then((res) => {
                expect(res).to.eql([errors.missingMaxCpmBidError]);
                done();
            }, (err) => {
