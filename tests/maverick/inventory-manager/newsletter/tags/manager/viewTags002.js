...
describe('<STABLE> {{MAVERICK}} inventory manager - newsletter {tags} @ADMIN >>> ' +
    '(+) view code - publisher details >>>', function() {
    ...
    it('should create a newsletter', (done) => {
        ...
        newsletterFixture.name += timeStamp + 12;
        newsletterFormPage
    ...
    it('should be able to view newsletter tags', (done) => {
        publisherDetailsPage
            .searchNewsletter(newsletterFixture.name);
        publisherDetailsPage
            .clickViewTags()
            .getTagCode()
            .then((res) => {
