...
describe('<UNSTABLE> {{MAVERICK}} /line-item {UI} @MANAGER >>> ' +
    ...
    it('location target section should contain all elements', function(done) {
        expect(lineItemPage.getSwitchLocation()).to.exist;
        expect(lineItemPage.getCheckPostalCodes()).to.exist;
        expect(lineItemPage.getCheckCountry()).to.exist;
        expect(lineItemPage.getButtonLocationTarget()).to.exist;
        driver.sleep(driverTimeOut).then(() => done());
    });

    it('search section should contain all elements', function(done) {
        lineItemPage.clickSwitchLocation();
        expect(lineItemPage.getInputSearchLocations()).to.exist;
        driver.sleep(driverTimeOut).then(() => done());
    });

    it('postal codes section should contain all elements', function(done) {
        lineItemPage.clickPostalCode();
        expect(lineItemPage.getInputSearchCountry()).to.exist;
        expect(lineItemPage.getTextPostalCodes()).to.exist;
        expect(lineItemPage.getButtonAddPostalCodes()).to.exist;
        driver.sleep(driverTimeOut).then(() => done());
    });
    ...
    it('should show correct data in Postal codes country box', function(done) {
        ...
        expect(lineItemPage.getSearchedElement()).to.exist;
