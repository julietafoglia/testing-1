...
const targetIo = targetAdvertiser.children.insertionOrder003;
const targetCampaign = targetIo.children.campaign004;
...
describe('<SMOKE> {{MAVERICK}} /line-item {UI} @MANAGER >>> ' +
    '(+) verify ui elements - house performance - create >>>', function() {
