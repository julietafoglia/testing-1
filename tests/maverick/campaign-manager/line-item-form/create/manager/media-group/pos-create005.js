...
testData001.name = 'SC5 ' + testData001.name + timeStamp;
...
describe('<SMOKE> {{MAVERICK}} /line-item {create} @MANAGER >>> ' +
    '(+) body - minimum required - EX - perf max clicks SC5 lifetime >>>',
function() {
    ...
    it('SC5 line item should be created - minimum required', function(done) {
