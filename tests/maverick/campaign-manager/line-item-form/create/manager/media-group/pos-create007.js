...
testData001.name = 'SC7 ' + testData001.name + timeStamp;
...
describe('<SMOKE> {{MAVERICK}} /line-item {create} @MANAGER >>> ' +
    '(+) body - minimum required - EX - perf max conv SC7 daily >>>',
function() {
    ...
    it('SC7 line item should be created - minimum required', function(done) {
