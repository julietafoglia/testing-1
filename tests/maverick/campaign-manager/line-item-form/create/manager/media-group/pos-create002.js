...
testData001.name = 'SC2 ' + testData001.name + timeStamp;
...
describe('<SMOKE> {{MAVERICK}} /line-item {create} @MANAGER >>> ' +
    '(+) body - minimum required - EX - perf max conv SC2 lifetime >>>',
function() {
    ...
    it('SC2 line item should be created - minimum required', function(done) {
