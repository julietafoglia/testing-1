...
testData001.name = 'SC1 ' + testData001.name + timeStamp;
...
describe('<SMOKE> {{MAVERICK}} /line-item {create} @MANAGER >>> ' +
    '(+) body - minimum required - ds - EX branding clicks SC1 >>>',
function() {
    ...
    it('navigate to new line item form', function(done) {
    ...
    it('SC1 line item should be created - minimum required', function(done) {
