...
const targetCampaign = targetIo.children.dspCampaigns[5];
...
testData001.name = 'SC6 ' + testData001.name + timeStamp;
...
describe('<SMOKE> {{MAVERICK}} /line-item {create} @MANAGER >>> ' +
    '(+) body - minimum required - EX - perf pay per conv SC6 >>>',
function() {
    ...
    it('SC6 line item should be created - minimum required', function(done) {
