...
const targetCampaign = targetIo.children.dspCampaigns[2];
...
testData001.name = 'SC3 ' + testData001.name + timeStamp;
...
describe('<SMOKE> {{MAVERICK}} /line-item {create} @MANAGER >>> ' +
    '(+) body - minimum required - EX - perf pey per clicks SC3 >>>',
function() {
    ...
    it('lnavigate to line item form page', function(done) {
    ...
    it('SC3 line item should be created - minimum required', function(done) {
