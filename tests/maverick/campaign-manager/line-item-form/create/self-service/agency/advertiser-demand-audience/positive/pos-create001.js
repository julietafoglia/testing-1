...
describe('<UNSTABLE> {{MAVERICK}} /line-item {create} ' +
    '@SS-AGENCY-ADVERTISER >>> (+) body - minimum required - media group >>>',
function() {
    ...
    it('navigate to Insertion Order detail page', function(done) {
    ...
    it('navigate to Campaign detail page', function(done) {
    ...
    it('navigate to New Line Item form page', function(done) {
