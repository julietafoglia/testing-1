...
testData001.name = testData001.name + timeStamp +
    ' (ssp - ds - branding - clicks)';

describe('<SMOKE> {{MAVERICK}} /campaign {create} @MANAGER >>> SSP ' +
    '(+) direct sold - branding - clicks - minimum required >>>', function() {
    ...
    it('campaign should be created - ssp - ds - branding - clicks',
        function(done) {
