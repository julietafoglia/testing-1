...
testData001.name = testData001.name + timeStamp +
    ' (ssp - hc - perf max clicks)';

describe('<SMOKE> {{MAVERICK}} /campaign {create} @MANAGER >>> SSP ' +
    '(+) house - performance - max clicks - minimum required >>>', function() {
    ...
    it('maverick - navigate to campaign form - ' +
        'performance - max clicks', function(done) {
    ...
    it('campaign should be created - ssp - house - perf max clicks',
        function(done) {
