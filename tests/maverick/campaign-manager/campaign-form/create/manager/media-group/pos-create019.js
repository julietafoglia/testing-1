...
testData001.name = testData001.name + timeStamp +
    ' (ssp - hc - branding - conversions)';

describe('<SMOKE> {{MAVERICK}} /campaign {create} @MANAGER >>> SSP ' +
    '(+) house - branding - conversions - minimum required >>>', function() {
    ...
    it('maverick - navigate to campaign form - ' +
        'branding - conversions', function(done) {
    ...
    it('campaign should be created - ssp - house - branding conversion',
        function(done) {
