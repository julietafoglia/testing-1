...
testData001.name = testData001.name + timeStamp + ' (branding - clicks)';

describe('<SMOKE> {{MAVERICK}} /campaign {create} @MANAGER >>> ' +
    'DSP (+) branding - clicks - minimum required >>>', function() {
    ...
    it('campaign should be created - dsp - branding - clicks', function(done) {
