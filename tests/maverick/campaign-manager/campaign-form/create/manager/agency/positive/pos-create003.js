...
testData001.name = testData001.name + timeStamp + ' (performance - max reach)';

describe('<SMOKE> {{MAVERICK}} /campaign {create} @MANAGER >>> ' +
    'SSP (+) performance - max reach - minimum required >>>', function() {
    ...
    it('campaign should be created - ssp - performance - max reach',
        function(done){
