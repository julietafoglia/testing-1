...
testData001.name = testData001.name + timeStamp + ' (performance - max clicks)';
...
describe('<UNSTABLE> {{MAVERICK}} /campaign {create} @SS-AGENCY-ADVERTISER ' +
    '>>> (+) performance - max clicks - minimum required >>>', function() {
