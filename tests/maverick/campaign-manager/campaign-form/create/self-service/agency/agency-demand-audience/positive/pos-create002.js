...
testData001.name = testData001.name + timeStamp + ' (branding - conversions)';
...
describe('<UNSTABLE> {{MAVERICK}} /campaign {create} @SS-AGENCY >>> ' +
    '(+) branding - conversions - minimum required >>>', function() {
    ...
    it('campaign should be created - branding - conversions', function(done) {
