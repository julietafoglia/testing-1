...
const agenciesTitle = 'AGENCY NAME';
...
describe('<SMOKE-PROD> {{MAVERICK}} /accounts-library {UI} @MANAGER >>> ' +
    '(+) verify agency accounts library ui elements >>>', function() {
    ...
    before('get webdriver and reset session', (done) => {
        ...
        agency = Object.assign({}, agencyTestFixture);
    ...
    it('should navigate to Accounts at Internal Tools section', function(done){
        ...
        accountsLibrary.waitUntilSpinnerNotVisible();
        driver.sleep(driverTimeOut).then(() => done());
    });

    it('should display all accounts library page elements', function(done) {
        ...
        accountsLibrary.getColumnAccountNameTitle().getText().
            then(function(getText) {
                expect(getText).to.equal(agenciesTitle);
            });
    ...
    it('should show table after removing filter added', function(done) {
        accountsLibrary.removeFilterOption('iniTestAgency');
