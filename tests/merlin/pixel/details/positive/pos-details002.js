...
describe('{{MERLIN}} /pixel {id details} @ADMIN >>> ' +
    '(+) url - all valid fields verification - media group >>>', function() {
    ...
    it('response object key values should match created object', function() {
        ...
        expect(resOutput004.dspConversionType)
            .to.equal(resOutput003.dspConversionType);
        ...
        expect(resOutput004.modified).to.equal(resOutput003.modified);
