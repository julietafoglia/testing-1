...
const testFixture =
    require(rootPath + '/fixtures/common/pixel/create004');
...
describe('{{MERLIN}} /pixel {create} @ADMIN >>> ' +
    '(-) body - dspConversionType required if type is dsp >>>', function() {
    ...
    before('create pixel - missing dspConversionType', function(done) {
    ...
    it('should contain a dspConversionType required error', function() {
        expect(resText003.errors).to.deep.include.members([
            {'id': 'E1177', 'code': 'REQ', 'details': 'dspConversionType'}
        ]);
    });
