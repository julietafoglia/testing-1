...
const testFixture =
    require(rootPath + '/fixtures/common/pixel/create003');
...
describe('{{MERLIN}} /pixel {create} @ADMIN >>> ' +
    '(-) body - should not save dspConversionType ' +
    'if type is ssp >>>', function() {
    ...
    before('create pixel - type ssp and dspConvertionType', function(done) {
    ...
    it('dspConversionType should be null', function() {
        expect(resOutput003.dspConversionType).to.equal(null);
    });
