...
describe('{{MERLIN}} /pixel {create} @ADMIN >>> ' +
    '(-) body - should fail under deleted advertiser >>>', function() {
    ...
    before('create pixel - fill with required fields', function(done) {
    ...
    it('response should contain INV error for advertiser field', function() {
        expect(resText003.errors).to.deep.include.members([
            {'id': 'E1176', 'code': 'INV', 'details': 'advertiser'}
        ]);
    });
