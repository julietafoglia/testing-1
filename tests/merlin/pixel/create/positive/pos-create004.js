...
describe('{{MERLIN}} /pixel {create} @ADMIN >>> ' +
    '(+) url - trailing slash appended to end the url >>>', function() {
    ...
    before('create pixel - url end trailing slash', function(done) {
    ...
    it('response object key values should match ' +
        'verify object(s) and default values', function() {
