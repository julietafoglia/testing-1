...
describe('{{MERLIN}} /media-group {create} @ADMIN >>> ' +
    '(-) body - missing contract object >>>', function() {
    ...
    before('create media-group - missing contract', function(done) {
        ...
        // delete contract
        delete sendBody001.contractType;
    ...
    it('response should contain a contract required error', function() {
        expect(resText001.errors).to.deep.include.members([
            {'id': 'E1001', 'code': 'REQ', 'details': 'contractType'}
        ]);
    });
