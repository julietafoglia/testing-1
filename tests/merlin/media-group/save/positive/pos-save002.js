...
const testFixture =
    require(rootPath + '/fixtures/common/media-group/save001');
...
describe('{{MERLIN}} /media-group {id save} @ADMIN >>> ' +
    ...
    before('save media-group - null non-required fields', function(done) {
    ...
    it('response object key values should match test object', function() {
        ...
        expect(resOutput002.salesforceId)
            .to.equal(resOutput001.salesforceId); // check updated
