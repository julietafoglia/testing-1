...
describe('{{MERLIN}} /media-group {id save} @ADMIN >>> ' +
    ...
    before('save media-group - invalid version', function(done) {

        sendBody002 = {};

        // assign invalid version
        sendBody002.version = chance.string({length: 5, pool: characterPool});
    ...
    it('response should contain an invalid version error', function() {
