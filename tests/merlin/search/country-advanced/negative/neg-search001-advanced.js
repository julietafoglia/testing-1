...
describe('{{MERLIN}} /search/country {advanced} @ADMIN >>> ' +
    ...
    before('search country - body - missing', function(done) {

        // missing request send body

        request(targetServer)
            .post(util.format(targetEndpoint.searchCountryAdvanced))
            .set(authHeaders)
            .then( function(res) {
    ...
    it('response object property types should match spec', function() {
        ...
        expect(resOutput001[0].iso2).to.have.length.of.at.most(2);
        expect(resOutput001[0].iso3).to.have.length.of.at.most(3);
    });
});
