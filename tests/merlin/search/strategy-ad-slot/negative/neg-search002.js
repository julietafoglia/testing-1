...
describe('{{MERLIN}} /search/strategy/ad-slot >>> ' +
    '(+) different ad-slot mediatype - one linked strategy >>>', function() {
    ...
    it('strategy - link creatives', function(done) {
        sendBody012 = {};
    ...
    it('link strategy to ad-slot', (done) => {
        let payload = {
    ...
    it('notices should exist', function() {
        expect(resText013.notices).to.have.lengthOf(1);
    });

    it('search linked strategies', (done) => {
        request(targetServer)
            .get(
                util.format(
    ...
    it('should not have a linked strategy', () => {
        expect(resOutput010).to.have.lengthOf(0);
    });
