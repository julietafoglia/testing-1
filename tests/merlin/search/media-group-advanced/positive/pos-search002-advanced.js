...
describe('{{MERLIN}} <SMOKE> /search/media-group {advanced} @ADMIN >>> ' +
    ...
    it('response object property types should match spec', function() {
        ...
        expect(/^[a-f0-9]{32}$/.test(resOutput001[0].manager)).to.be.true;
        expect(resOutput001[0].managerName).to.have.length.of.at.most(100);
