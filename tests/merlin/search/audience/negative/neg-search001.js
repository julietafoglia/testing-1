...
describe('{{MERLIN}} /search/audience @ADMIN >>> ' +
    ...
    before('create audience', function(done) {
        setupFixture003.name += '_ghostrider';
        sendBody004 = {};
        Object.assign(
            sendBody004,
            setupFixture003
    ...
    it('search audience - body valid', function(done) {

        key004 = 'name';
        value004 = resOutput004.name;
    ...
    // audience search has been changed to elastic search
