...
describe('{{MERLIN}} <SMOKE> /search/audience @ADMIN >>> ' +
    ...
    before('search audience', function(done) {
        request(targetServer)
            .get(util.format(targetEndpoint.searchAudience))
            .set(authHeaders)
            .then( function(res) {
    ...
    it('response object property types should match spec', function() {
        ...
        expect(validator.isInt(resOutput001[0].records + '')).to.be.true;
