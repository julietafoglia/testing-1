...
describe('{{MERLIN}} /search/ssp-control/publisher {advanced} @ADMIN >>> ' +
    '(-) body - unsupported order-by field >>>', function() {
    ...
    before('search ssp-control-publisher', function(done) {
        ...
        sendBody001.orderBy = 'publisherId';
    ...
    it('should return an invalid order-by publisher error', function() {
        expect(resText001.errors).to.deep.include.members([
            {'id': 'E1000', 'code': 'INV', 'details': 'orderBy:publisherId'}
        ]);
    });
