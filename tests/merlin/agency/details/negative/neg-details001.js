...
describe('{{MERLIN}} /agency/{id details} @ADMIN >>> ' +
    '(-) url - invalid uri characters >>>', function() {
    ...
    before('get agency details - invalid uri characters', function(done) {
        request(targetServer)
            .get(util.format(
                targetEndpoint.agencyDetails,
                '!!' + resOutput001.id + '!!'
            )
            )
            .set(authHeaders)
