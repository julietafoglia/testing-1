...
describe('{{MERLIN}} <SMOKE> /agency/{id delete} @ADMIN >>> ' +
    '(+) url - basic verification - Advertiser Agency >>>', function() {
    ...
    before('create agency - Advertiser Agency', function(done) {
        sendBody001 = {};
        Object.assign(
            sendBody001,
            setupFixture
    ...
    before('delete agency', function(done) {
        request(targetServer)
