...
describe('{{MERLIN}} /agency/{id save} @ADMIN >>> ' +
    ...
    before('save agency - invalid fields - multiple', function(done) {
        sendBody002 = {};
        sendBody002.version = resOutput001.version;
        sendBody002.name = resOutput001.name + ' Y';

        // create random manager hash
        sendBody002.manager = 'ghost' + chance.hash({length: 27});

        // create other invalid key values
        sendBody002.type = '<h1>Monkey</h1>';
        sendBody002.isApiPartner = '<h1>Yaaaaaas</h1>';
        sendBody002.contract = {};
        sendBody002.contract.selfServe = 'Foolse';
