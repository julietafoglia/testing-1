...
// fixture(s)
const setupFixture001 = require(rootPath + '/fixtures/common/agency/create003');
...
describe('{{MERLIN}} <SMOKE> /agency/{id save} @ADMIN >>> ' +
    ...
    before('save agency - all valid fields', function(done) {
        sendBody002 = {};
        Object.assign(
            sendBody002,
            testFixture
    ...
    it('response object key values should match test object', function() {
        expect(resOutput002.salesforceId)
            .to.equal(sendBody002.salesforceId);
        ...
        expect(resOutput002.isApiPartner)
            .to.equal(sendBody002.isApiPartner);
    });
