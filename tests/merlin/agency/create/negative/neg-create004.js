...
describe('{{MERLIN}} /agency {create} @ADMIN >>> ' +
    '(-) body - missing required - type >>>', function() {
    ...
    before('create agency - missing required - type', function(done) {
        sendBody001 = {};
        Object.assign(
            sendBody001,
            testFixture
        );
        delete sendBody001.type;
    ...
    it('errors should include required type', function() {
