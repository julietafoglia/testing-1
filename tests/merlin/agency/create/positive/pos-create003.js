...
describe('{{MERLIN}} /agency {create} @ADMIN >>> ' +
    ...
    before('create agency - string fields - max length', function(done) {
        sendBody001 = {};
        Object.assign(
            sendBody001,
            testFixture
        ...
        // create random string key values to max length allowed
        sendBody001.salesforceId = chance.string({length: 32});
        sendBody001.name += timeStamp + chance.string({length: 4});
        sendBody001.description = chance.string({length: 200});
