...
describe('{{MERLIN}} /publisher {id save} >>> ' +
    '(-) request - POST - body invalid >>>', function() {
    ...
    before('save publisher - POST body invalid', function(done) {

        sendBody003 = '"SELECT * FROM publisher;"' ;
    ...
    // excluded due to DEM-1285
    xit('response should have status of 400', function() {
