...
describe('{{MERLIN}} /publisher {id save} >>> ' +
    ...
    before('save publisher - name and version', function(done) {

        sendBody003 = {};

        // assign name and version publisher
        ...
        request(targetServer)
            ...
            .then( function(res) {
                ...
                // spot check response
                expect(resText003.errors)
                    .to.not.exist;
                expect(resText003.notices)
                    .to.not.exist;
                expect(resText003.output.version)
                    .to.equal(resOutput002.version + 1);
                done();
            })
            .catch( function(err) {
                done(err);
    ...
    before('save publisher - previously updated version', function(done) {

        sendBody004 = {};

        // assign name and previous version publisher
