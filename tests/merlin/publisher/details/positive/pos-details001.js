...
describe('{{MERLIN}} <SMOKE> /publisher {id details} >>> ' +
    '(+) url - publisher with all valid fields >>>', function() {
    ...
    before('create publisher - all valid fields', function(done) {
        ...
        // assign random values to undefined fixture fields
    ...
    before('get publisher details - all valid fields', function(done) {
        request(targetServer)
