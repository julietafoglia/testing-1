...
describe('{{MERLIN}} /publisher {create} >>> ' +
    '(-) body - missing category field >>>', function() {
    ...
    before('create publisher - missing category field', function(done) {
    ...
    it('response should contain a category required error', function() {
