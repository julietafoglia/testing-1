...
describe('{{MERLIN}} /publisher {create} >>> ' +
    '(-) body - missing name field >>>', function() {
    ...
    before('create publisher - missing name field', function(done) {
        ...
        // delete name from publisher
        delete sendBody002.name;
    ...
    it('response should contain a name required error', function() {
