...
describe('{{MERLIN}} /publisher {create} >>> ' +
    '(-) body - invalid name field >>>', function() {
    ...
    before('create publisher - invalid name field', function(done) {
        ...
        // assign an invalid name to publisher
        sendBody002.name = chance.string({length: 256, pool: characterPool});
    ...
    it('response should contain an invalid name error', function() {
