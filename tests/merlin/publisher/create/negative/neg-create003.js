...
describe('{{MERLIN}} /publisher {create} >>> ' +
    '(-) body - invalid category field >>>', function() {
    ...
    before('create publisher - invalid category field', function(done) {
        ...
        // assign category a string instead of int
        sendBody002.category = chance.string({length: 5});
    ...
    it('response should contain an invalid category error', function() {
