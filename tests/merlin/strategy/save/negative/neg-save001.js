...
describe('{{MERLIN}} /strategy/{id save} @ADMIN >>> ' +
    '(-) request - media-group - POST - invalid body >>>', function() {
    ...
    before('save strategy - POST - invalid body', function(done) {
        sendBody006 = {};
        sendBody006.bad = 'monkey';
    ...
    it('reponse have status of 400', function() {
