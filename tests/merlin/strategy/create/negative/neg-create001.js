...
describe('{{MERLIN}} /strategy {create} @ADMIN >>> ' +
    '(-) url - media-group - string end - random >>>', function() {
    ...
    before('create strategy - string end - random', function(done) {
        sendBody005 = {};
        Object.assign(
            sendBody005,
            testFixture
    ...
    it('error should include bad request', function() {
        expect(resText005.error).to.contain('Not Found');
    });
