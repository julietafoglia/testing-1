...
const testFixture =
    require(rootPath + '/fixtures/common/creative/create003');
...
describe('{{MERLIN}} /creative {create} @ADMIN >>> ' +
    '(-) body - invalid fields - base 64 file >>>', function() {
    ...
    before('create creative - invalid fields - base 64 file', function(done) {
        sendBody003 = {};
        Object.assign(
            sendBody003,
            testFixture
    ...
    it('errors should include invalid file', function() {
        expect(resText003.errors).to.deep.include.members([
            {'id': 'E1000', 'code': 'INV', 'details': 'file'}
        ]);
    });
