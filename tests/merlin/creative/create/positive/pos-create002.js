...
const verifyFixture =
    require(rootPath + '/fixtures/common/creative/create002-verify');
...
describe('{{MERLIN}} <SMOKE> /creative/{id details} @ADMIN >>> ' +
    '(+) body - minimum required - base 64 file >>>', function() {
    ...
    before('create creative - minimum required - ' +
        'base 64 file', function(done) {
