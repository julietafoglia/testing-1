...
const testFixture =
    require(rootPath + '/fixtures/common/creative/create009');
const verifyFixture =
    require(rootPath + '/fixtures/common/creative/create009-verify');
...
describe('{{MERLIN}} <SMOKE> /creative/{id details} @ADMIN >>> ' +
    '(+) body - base 64 file - 970x550 - gif >>>', function() {
    ...
    before('create creative - base 64 file - 970x550 - gif', function(done) {
