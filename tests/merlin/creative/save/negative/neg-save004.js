...
describe('{{MERLIN}} /creative/{id save} @ADMIN >>> ' +
    '(-) body - invalid fields - status >>>', function() {
    ...
    before('save creative - invalid fields - status', function(done) {
        sendBody004 = {};
        sendBody004.version = resOutput003.version;
        sendBody004.name = resOutput003.name + ' @ ' +
            moment().format('YYYY-MM-DDTHH:mm:ss');
        sendBody004.status = 'inactive';
    ...
    it('notices should include unsupported status', function() {
