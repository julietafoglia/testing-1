...
describe('{{MERLIN}} /creative/{id save} @ADMIN >>> ' +
    ...
    before('save creative - string end - random characters', function(done) {
    ...
    it('error should equal invalid id', function() {
        expect(resText004.errors).to.be.an('array');
        expect(resText004.errors[0].code).to.be.eq('INV');
        expect(resText004.errors[0].details).to.be.eq('id');
    });
