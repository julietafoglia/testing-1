...
const testFixture =
    require(rootPath + '/fixtures/common/creative/save003');
...
describe('{{MERLIN}} /creative/{id save} @ADMIN >>> ' +
    '(-) body - invalid fields - file - size mismatch >>>', function() {
    ...
    before('save creative - invalid fields - ' +
        'file - size mismatch', function(done) {
    ...
    it('errors should include mismatched width and height', function() {
        expect(resText004.errors).to.deep.include.members([
            {'id': 'E1163', 'code': 'MIS', 'details': 'width'},
            {'id': 'E1164', 'code': 'MIS', 'details': 'height'}
        ]);
    });
