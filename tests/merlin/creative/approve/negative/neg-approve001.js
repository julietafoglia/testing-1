...
describe('{{MERLIN}} /creative/approve/{id}/{approvalKey} @ADMIN >>> ' +
    ...
    before('approve creative - string end - ' +
        'random characters', function(done) {
    ...
    it('errors should include invalid approval-key', function() {
        expect(resText005.errors).to.deep.include.members([
            {'id': 'E1000', 'code': 'INV', 'details': 'approvalKey'}
        ]);
    });
