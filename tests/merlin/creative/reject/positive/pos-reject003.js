...
describe('{{MERLIN}} /creative/reject/{id}/{approvalKey} @ADMIN >>> ' +
    ...
    before('reject creative - string fields - max length', function(done) {
        sendBody004 = {};
        sendBody004.version = resOutput003.version;
        sendBody004.rejectReason =
    ...
    it('creative status should be rejected', function() {
    ...
    it('response object key values should match test object', function() {
        ...
        expect(resOutput004.status)
            .to.equal('rejected'); // check updated
        ...
        expect(resOutput004.rejectReason)
            .to.equal(sendBody004.rejectReason); // check updated
