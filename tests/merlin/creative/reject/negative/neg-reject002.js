...
describe('{{MERLIN}} /creative/reject/{id}/{approvalKey} @ADMIN >>> ' +
    '(-) body - missing required - approval-key >>>', function() {
    ...
    before('reject creative - missing required - ' +
        'approval-key', function(done) {
    ...
    it('errors should include required approval-key', function() {
        expect(resText004.error).to.contain('Not Found');
    });
