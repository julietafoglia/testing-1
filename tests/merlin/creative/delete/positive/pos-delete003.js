...
describe('{{MERLIN}} <SMOKE> /creative/{id delete} @ADMIN >>> ' +
    '(+) url - status verification - url file >>>', function() {
    ...
    before('get creative details', function(done) {
        request(targetServer)
            .get(util.format(
    ...
    it('creative status should be deleted', function() {
