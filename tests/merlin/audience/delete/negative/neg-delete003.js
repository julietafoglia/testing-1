...
describe('{{MERLIN}} /audience {id delete} >>> ' +
    '(-) url - ends in invalid characters >>>', function() {
    ...
    before('delete audience - url end invalid', function(done) {
        request(targetServer)
            .del(util.format(
                targetEndpoint.audienceDelete,
                resOutput004.id +
    ...
    it('response should contain a invalid id error', function() {
