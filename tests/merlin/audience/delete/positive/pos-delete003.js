...
describe('{{MERLIN}} <SMOKE> /audience {id delete} >>> ' +
    '(+) request - delete audience with all valid fields >>>', function() {
    ...
    before('delete audience', function(done) {
        request(targetServer)
    ...
    before('save audience - version only', function(done) {
    ...
    it('response have status of 410', function() {
