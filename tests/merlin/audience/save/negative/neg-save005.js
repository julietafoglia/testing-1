...
describe('{{MERLIN}} /audience {id save} >>> ' +
    '(-) body - invalid previous version >>>', function() {
    ...
    before('save audience - name only', function(done) {

        sendBody005 = {};

        // assign name and version to audience
    ...
    before('save audience - invalid prevous version', function(done) {

        sendBody006 = {};

        // assign previously updated version to audience
