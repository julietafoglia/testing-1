...
describe('{{MERLIN}} /audience {id save} >>> ' +
    ...
    before('save audience - invalid version', function(done) {

        sendBody005 = {};

        // assign and invalid version to audience
        sendBody005.version =
            chance.string({length: 2, pool: characterPool}) + 1;

        // assign name to audience
        sendBody005.name =
            resOutput004.name + '@v2';
