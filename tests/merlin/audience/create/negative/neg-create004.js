...
describe('{{MERLIN}} /audience {create} >>> ' +
    ...
    before('create audience - invalid name', function(done) {

        sendBody003 = Object.assign({}, testFixture);

        // assign advertiser and an invalid name to audience
        sendBody003.advertiser = resOutput002.id;
        sendBody003.name = chance.string({length: 129, pool: characterPool});
