...
describe('{{MERLIN}} /audience {create} >>> ' +
    '(-) body - missing required - data provider Id >>>', function() {
    ...
    before('create audience - missing data provider id', function(done) {

        sendBody003 = Object.assign({}, testFixture);

        // assign advertiser to audience
    ...
    it('response should contain a data provider required error', function() {
        expect(resText003.errors).to.deep.include.members([
            {'id': 'E1001', 'code': 'REQ', 'details': 'dataProviderId'}
        ]);
    });
