...
describe('{{MERLIN}} /advertiser {create} @ADMIN >>> ' +
    '(-) body - missing required - domain >>>', function() {
    ...
    before('create advertiser - missing required - domain', function(done) {
        sendBody002 = {};
        Object.assign(
            sendBody002,
            testFixture
    ...
    it('errors should include required domain', function() {
