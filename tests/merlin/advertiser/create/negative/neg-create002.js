...
describe('{{MERLIN}} /advertiser {create} @ADMIN >>> ' +
    '(-) body - missing required - category >>>', function() {
    ...
    before('create advertiser - missing required - category', function(done) {
        sendBody002 = {};
        Object.assign(
            sendBody002,
            testFixture
    ...
    it('errors should include required category', function() {
