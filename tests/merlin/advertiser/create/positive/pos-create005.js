...
const testFixture =
    require(rootPath + '/fixtures/common/advertiser/create003');
...
describe('{{MERLIN}} <SMOKE> /advertiser {create} @ADMIN >>> ' +
    '(+) body - all valid fields - media-group >>>', function() {
    ...
    before('create advertiser - all valid fields', function(done) {

        sendBody002 = Object.assign({}, testFixture);

        // assign name, owner and description to advertiser
