...
describe('{{MERLIN}} /advertiser {id details} @ADMIN >>> ' +
    '(-) body - valid >>>', function() {
    ...
    before('get advertiser details - body - valid', function(done) {
    ...
    after('delete agency', function(done) {
        request(targetServer)
            .get(util.format(targetEndpoint.agencyDelete, resOutput001.id))
            .set(authHeaders)
            .then( function(res) {
                // basic response verification
                expect(res.body).to.exist;
