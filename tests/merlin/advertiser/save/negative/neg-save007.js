...
describe('{{MERLIN}} /advertiser {id save} @ADMIN >>> ' +
    ...
    before('save advertiser - invalid version', function(done) {

        sendBody003 = {};

        // assign an invalid version to request body
        sendBody003.version = chance.string({length: 10, pool: characterPool});
    ...
    it('errors should include invalid version', function() {
