...
describe('{{MERLIN}} /newsletter {id save} >>> ' +
    '(+) body - basic fields verification >>>', function() {
    ...
    before('save newsletter - basic fields', function(done) {
    ...
    it('response object key values should match test object', function() {
        ...
        // check ssp-control values
        expect(resOutput004.sspControl.rtbAllow).to.equal(null);
        expect(resOutput004.sspControl.rtbTransparency).to.equal(null);
        expect(resOutput004.sspControl.rtbFloor).to.equal(null);
