...
describe('{{MERLIN}} <SMOKE> /newsletter {id delete} >>> ' +
    '(+) request - delete newsletter with all valid fields >>>', function() {
    ...
    before('delete newsletter', function(done) {
        request(targetServer)
    ...
    before('get newsletter - all valid fields', function(done) {
