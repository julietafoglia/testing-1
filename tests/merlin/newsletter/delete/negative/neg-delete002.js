...
describe('{{MERLIN}} /newsletter {id delete} >>> ' +
    ...
    before('delete newsletter - missing id', function(done) {

        request(targetServer)
            .del(util.format(targetEndpoint.newsletterDetails, ''))
            .set(authHeaders)
            .then( function(res) {
    ...
    it('response object should contain a not found error', function() {
