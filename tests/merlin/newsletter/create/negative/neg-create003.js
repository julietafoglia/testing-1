...
describe('{{MERLIN}} /newsletter {create} >>> ' +
    '(-) body - missing category and secondaryCategories >>>', function() {
    ...
    before('create newsletter - missing multiple', function(done) {
        ...
        delete sendBody003.category;
        delete sendBody003.secondaryCategories;
    ...
    it('response object should contain required fields error', function() {
