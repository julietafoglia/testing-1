...
describe('{{MERLIN}} /newsletter {create} >>> ' +
    '(-) body - missing required - publisher >>>', function() {
    ...
    before('create newsletter - missing publisher field', function(done) {
        ...
        // remove publisher from request body
        delete sendBody001.publisher;
    ...
    it('response object should contain a publisher required error', function() {
