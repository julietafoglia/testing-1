...
describe('{{MERLIN}} /newsletter {create} >>> ' +
    ...
    before('create newsletter - invalid name field', function(done) {
        ...
        // assign an invalid name to newsletter
    ...
    it('response object should contain an invalid name error', function() {
