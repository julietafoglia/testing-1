...
describe('{{MERLIN}} /newsletter {create} >>> ' +
    ...
    before('create newsletter - missing name field', function(done) {
        ...
        // remove name from request body
        delete sendBody003.name;
    ...
    it('response object should contain a name required error', function() {
