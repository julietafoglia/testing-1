...
describe('{{MERLIN}} /newsletter {create} >>> ' +
    ...
    before('create newsletter - missing multiple fields', function(done) {

        sendBody003 = {};

        // assign name publisher to newsletter
        sendBody003.name += timeStamp;
        sendBody003.publisher = resOutput002.id;

        // assign invalid fields to newsletter
        sendBody003.category = chance.string({length: 5, pool: characterPool});
        sendBody003.secondaryCategories =
            chance.n(chance.string, 5, {length: 2, pool: characterPool});
        sendBody003.externalId =
            chance.string({length: 129, pool: characterPool});
        sendBody003.tagsUrlPrefix =
            chance.string({length: 129, pool: characterPool});
        sendBody003.estimatedInventory =
            chance.string({length: 5, pool: characterPool});
        // ssp-control object
        sendBody003.sspControl = {};
        sendBody003.sspControl.exchangeAllow = chance.string({length: 2});
        sendBody003.sspControl.rtbAllow = chance.string({length: 2});
        sendBody003.sspControl.rtbTransparency = chance.string({length: 2});
        sendBody003.sspControl.rtbFloor =
            chance.string({length: 5});
        sendBody003.sspControl.uniqueAds = chance.string({length: 2});
        sendBody003.sspControl.userMatchAllow = chance.string({length: 2});
        sendBody003.sspControl.demandAllocationHouse =
            chance.string({length: 2});
        sendBody003.sspControl.demandAllocationDirect =
            chance.string({length: 5});
        sendBody003.sspControl.directoryExpose = chance.string({length: 2});
        sendBody003.sspControl.directoryExposePublic =
            chance.string({length: 2});
    ...
    it('response should contain an error for each invalid field', function() {
        expect(resText003.errors).to.deep.include.members([
            ...
            {'id': 'E1000', 'code': 'INV', 'details': 'secondaryCategories'},
            {'id': 'E1000', 'code': 'INV', 'details': 'externalId'},
            {'id': 'E1000', 'code': 'INV', 'details': 'tagsUrlPrefix'},
            {'id': 'E1000', 'code': 'INV', 'details': 'estimatedInventory'},
            {'id': 'E1000', 'code': 'INV',
                'details': 'sspControl:exchangeAllow'},
            {'id': 'E1000', 'code': 'INV',
                'details': 'sspControl:rtbAllow'},
            {'id': 'E1000', 'code': 'INV',
                'details': 'sspControl:rtbTransparency'},
            {'id': 'E1000', 'code': 'INV',
                'details': 'sspControl:rtbFloor'},
            {'id': 'E1000', 'code': 'INV',
                'details': 'sspControl:uniqueAds'},
            {'id': 'E1000', 'code': 'INV',
                'details': 'sspControl:userMatchAllow'},
            {'id': 'E1000', 'code': 'INV',
                'details': 'sspControl:demandAllocationHouse'},
            {'id': 'E1000', 'code': 'INV',
                'details': 'sspControl:demandAllocationDirect'},
            {'id': 'E1000', 'code': 'INV',
                'details': 'sspControl:directoryExpose'},
            {'id': 'E1000', 'code': 'INV',
                'details': 'sspControl:directoryExposePublic'}
        ]);
    });
