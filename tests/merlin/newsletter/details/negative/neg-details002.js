...
describe('{{MERLIN}} /newsletter {id details} >>> ' +
    ...
    before('get newsletter - missing id', function(done) {
        request(targetServer)
            .get(util.format(targetEndpoint.newsletterDetails, ''))
            .set(authHeaders)
            .then( function(res) {
    ...
    it('response object should contain an not found error', function() {
