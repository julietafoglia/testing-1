...
describe('{{MERLIN}} /bundle {id save} >>> ' +
    '(+) body - update minimum required fields >>>', function() {
    ...
    before('update bundle - minimum required fields', function(done) {
    ...
    it('response object should match test object', function() {
        ...
        expect(resOutput002.name).to.equal(sendBody002.name); // updated name
