...
describe('{{MERLIN}} /bundle {id save} >>> ' +
    '(-) body - update with an invalid name >>>', function() {
    ...
    before('update bundle - invalid name', function(done) {
        ...
        // assign an invalid name to bundle
        sendBody002.name = chance.word({length: 33});
    ...
    it('should return a invalid name error', function() {
