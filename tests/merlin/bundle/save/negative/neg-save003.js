...
describe('{{MERLIN}} /bundle {id save} >>> ' +
    '(-) body - update with invalid version >>>', function() {
    ...
    before('update bundle - invalid version', function(done) {

        sendBody002 = Object.assign({}, testFixture);

        // assign name and an invalid version to bundle\
        sendBody002.name = resOutput001.name + '@v2';
        sendBody002.version = chance.word({length: 3});
    ...
    it('should return a invalid version error', function() {
