...
// fixture(s)
const testFixture =
    require(rootPath + '/fixtures/common/bundle/create003');
...
describe('{{MERLIN}} /bundle {create} >>> ' +
    ...
    before('create bundle - null non-required fields', function(done) {
    ...
    it('response object key values should match test object', function() {
        ...
        expect(resOutput001.publisher).to.equal(sendBody001.publisher);
    });
