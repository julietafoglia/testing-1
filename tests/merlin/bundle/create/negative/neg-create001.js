...
describe('{{MERLIN}} /bundle {create} >>> ' +
    '(-) body - invalid description >>>', function() {
    ...
    before('create bundle - invalid description', function(done) {
        ...
        // assign an invalid description to bundle
        sendBody003.description = chance.word({length: 256});
    ...
    it('should return a invalid description error', function() {
        expect(resText003.errors).to.deep.include.members([
            {'id': 'E1000', 'code': 'INV', 'details': 'description'}
        ]);
    });
