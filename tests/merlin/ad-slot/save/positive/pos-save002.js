...
const testFixture =
    require(rootPath + '/fixtures/common/ad-slot/save001');
...
describe('{{MERLIN}} <SMOKE> /ad-slot {id save} >>> ' +
    ...
    before('save ad-slot - all valid fields', function(done) {

        sendBody005 = Object.assign({}, testFixture);

        // assign version to ad-slot
    ...
    it('response object key values should match test object', function() {
        ...
        // ssp control object
        expect(resOutput005.sspControl.exchangeAllow)
            .to.equal(sendBody005.sspControl.exchangeAllow);
        // Refer to SVC-4123
        // expect(resOutput005.sspControl.exchangeFloor)
        //    .to.equal(sendBody005.sspControl.exchangeFloor);
        // expect(resOutput005.sspControl.targetingType)
        //    .to.equal(sendBody005.sspControl.targetingType);
