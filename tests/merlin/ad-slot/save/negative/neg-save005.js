...
describe('{{MERLIN}} /ad-slot {id save} >>> ' +
    '(-) body - update non-editable fields >>>', function() {
    ...
    before('save ad-slot - non-editable fields', function(done) {
        ...
        sendBody005.refId = chance.integer();
        sendBody005.newsletter = chance.hash({length: 32});
        sendBody005.type = 'image';
        sendBody005.mediaType = 'dedicated';
    ...
    it('response should have notices for unsupported fields', function() {
        expect(resText005.notices).to.deep.include.members([
            {'refId': 'UNS'},
            {'newsletter': 'UNS'},
            {'mediaType': 'UNS'},
            {'type': 'UNS'}
