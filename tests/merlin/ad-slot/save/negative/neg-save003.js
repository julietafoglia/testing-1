...
describe('{{MERLIN}} /ad-slot {id save} >>> ' +
    '(-) body - invalid required fields during create >>>', function() {
    ...
    before('save ad-slot - invalid required fields', function(done) {
        ...
        // assign invalid values to required fields during create
        sendBody005.name = chance.string({length: 300, pool: characterPool});
    ...
    it('response should contain a invalid name error', function() {
