...
const testFixture =
    require(rootPath + '/fixtures/common/ad-slot/create003');
...
describe('{{MERLIN}} <SMOKE> /ad-slot {create} >>> ' +
    '(+) body - all valid fields - content >>>', function() {
    ...
    it('notices and errors should not exist', function() {
        // Some notices exist when creating an adslot
