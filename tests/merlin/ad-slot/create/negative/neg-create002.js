...
describe('{{MERLIN}} /ad-slot {create} >>> ' +
    '(-) body - missing multiple fields >>>', function() {
    ...
    before('create ad-slot - missing multiple fields', function(done) {
