...
describe('{{MERLIN}} /ad-slot {create} >>> ' +
    '(-) request - POST with a missing body >>>', function() {
    ...
    before('create ad-slot - missing request body', function(done) {
    ...
    it('response should contain error for each required field', function() {
