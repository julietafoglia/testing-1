...
describe('{{MERLIN}} /campaign {create} @ADMIN >>> ' +
    ...
    before('create agency - minimum required fields', function(done) {
    ...
    it('notices should exist and errors should not exist', function() {
        // notices are expected since unsupported IF
        // insertionOrder.advertiser.owner.type == Agency
