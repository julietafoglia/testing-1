...
describe('{{MERLIN}} /insertion-order {id save} @ADMIN >>> ' +
    ...
    before('save insertion order - invalid advertiser', function(done) {

        sendBody004 = {};
        sendBody004.version = resOutput003.version;

        // assign invalid advertiser
        sendBody004.advertiser = 'ghost' + chance.hash({length: 27});
    ...
    it('response should include an invalid advertiser error', function() {
