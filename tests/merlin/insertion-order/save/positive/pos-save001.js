...
describe('{{MERLIN}} /insertion-order {id save} @ADMIN >>> ' +
    ...
    before('save insertion order - ad-server', function(done) {

        sendBody004 = {};

        // assign ad-server, name and version
        sendBody004.adServer = 'MediaMind';
    ...
    it('response object key values should match test object', function() {
        ...
        expect(resOutput004.budget)
            .to.equal(resOutput003.budget);
        expect(resOutput004.isUnlimitedBudget)
            .to.equal(resOutput003.isUnlimitedBudget);
