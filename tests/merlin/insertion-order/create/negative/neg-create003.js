...
describe('{{MERLIN}} /insertion-order {create} @ADMIN >>> ' +
    '(-) body - missing required - dates >>>', function() {
    ...
    before('create insertion order - missing dates', function(done) {
        ...
        // remove send body dates
        delete sendBody003.startDate;
        delete sendBody003.endDate;
    ...
    it('errors should include required dates', function() {
