...
describe('{{MERLIN}} /insertion-order {create} @ADMIN >>> ' +
    '(-) body - missing required - trafficker >>>', function() {
    ...
    before('create insertion order - missing trafficker', function(done) {
        ...
        // remove send body trafficker
        delete sendBody003.trafficker;
    ...
    it('errors should include required trafficker', function() {
