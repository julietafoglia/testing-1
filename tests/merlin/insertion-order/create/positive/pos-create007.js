...
const testFixture =
    require(rootPath + '/fixtures/common/insertion-order/create004');
...
describe('{{MERLIN}} /insertion-order {create} @ADMIN >>> ' +
    '(+) body - null non-required fields - agency >>>', function() {
    ...
    before('create insertion order - null non-required', function(done) {
